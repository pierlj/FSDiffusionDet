...
class TransductiveTrainer(DiffusionTrainer):
    ...
    @classmethod
    def build_test_loader(cls, cfg, selected_classes, dataset_name, validation=False):
    ...
    def build_hooks(self):
        ...
        def test_and_save_results(validation=True, is_finetuning=False):
            ...
            self._last_eval_results = self.eval(self.cfg, self.model, evaluators, validation=validation)
    ...
    @classmethod
    def eval(cls, cfg, model, evaluators, validation=False):
        """
        ...
        for idx, evaluator in enumerate(evaluators):
            ...
            dataloader = cls.build_test_loader(cfg, evaluator.selected_classes, [dataset_name], validation=validation)
